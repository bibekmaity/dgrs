...
if($tk>0)
{
    ...
    { 
        ...
        <tr>
        <td colspan="6" align="left"  style=" border-top:none !important;border-bottom:none !important;"><B><?php echo " Complaints Pending ";?></B></td>
        ...
        $sql1.=" ORDER BY f.comp_type_id,f.dkt_date,f.dkt_no DESC ";
