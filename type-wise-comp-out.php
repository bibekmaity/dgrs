...
if($tk>0)
{
    ...
    { 
        ...
        <tr>
        <td colspan="14" align="center"  style=" border-top:none !important;border-bottom:none !important;"><B><?php echo "Type Wise Complaints <br />Period: $from_date1 - $to_date1";?></B></td>
        </tr>
        <tr>
        ...
        <td align="center" class="one"><B>Comp Type</B></td>
