...
$comp_type = isset($_POST['block']) ? $_POST['block'] : '';
...
if($tk>0)
{
    ...
    { 
        ...
        <td colspan="11" align="center" style=" border-bottom:none !important;">&nbsp;</td>  
        </tr>
        <tr>
        <td colspan="12" align="center"  style=" border-top:none !important;border-bottom:none !important;"><B><?php echo "Type Wise Complaints <br />Period: $from_date1 - $to_date1";?></B></td>
        </tr>
        <tr>
        <td colspan="12" align="right"  style=" border-top:none !important;"><B>Print Date : <?php echo $print_date; ?> Time : <?php echo $print_dt[1]; ?></B></td>
        </tr>
        </thead> 
        ...
        $sql1.=" cm.comp_type_eng,dm.de_eng,f.refer_to,f.refer_date  ";
		...
		if(!empty($comp_type))
		{
       	 	$sql1.=" and f.comp_type_id=:comp_type ";
		}
		...
		if(!empty($comp_type))
		{
	        $sth->bindParam(':comp_type', $comp_type);
		}
		if($ses_user_type=="B")
		{
        ...
        foreach ($row1 as $key => $value1) 
        {
            ...
            $refer_date1=$value1['refer_date'];
            
            $dkt_date=british_to_ansi(substr($dkt_date1,0,10));
            $dkt_time=substr($dkt_date1,11,5);

            $ref_date=british_to_ansi(substr($refer_date1,0,10));
            $ref_time=substr($refer_date1,11,5);
            ...
            <td nowrap align="center"p><?php echo "$ref_dt";?></td>
            </tr>
            <?php
        }
    	?>
