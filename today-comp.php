...
if($tk>0)
{
    ...
    { 
        ...
        <tr>
        <td colspan="6" align="left"  style=" border-top:none !important;border-bottom:none !important;"><B><?php echo "Todays Complaints ";?></B></td>
        ...
        <td align="center"><B>DktDate</B></td>
        ...
        $sql1.=" and substr(f.dkt_date,1,10)=CURRENT_DATE ";
