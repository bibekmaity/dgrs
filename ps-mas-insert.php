...
if($submit=="Submit")
{
 ...
 // echo $ct;
  if($ct>0)
  {
     ...
     $stmt3.="FROM ps_mas ";
     $stmt3.="where ps_nm=:dept_nm and sub_div_id=:sub_div ";
     ...
     if($total<=0)
     {
        $sqlC ="insert into ps_mas(dist_id,sub_div_id,ps_nm_ben,ps_nm "; 
        $sqlC.=" )values( ";
        $sqlC.=":ses_dist_id,:sub_div,:dept_nm_ben,:dept_nm ";
        $sqlC.=")";
		...
		?>
   	 	<script>
      		alert('Police Station Inserted Successfully.');      
      	</script>
     	<?Php
     }
  }
                    ...
                    <div class="box-body">
                      <div class="col-md-6">
                        <div class="form-group">
                           <label for="Block Name" class="col-sm-4">Name (English) <font color="#FF0000">*</font></label>
                           <div class="col-sm-8">
                           ...
                           <div class="col-sm-8">
							...
							foreach ($rowS as $keyS => $valueS) 
							{
								...
								?>
                                 ...
                                 <option value="<?php echo $sub_div_id; ?>">
