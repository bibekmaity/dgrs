...
<form name="form1"  method="post" class="form-horizontal" enctype="multipart/form-data" onSubmit="return validate()" action="<?php echo $full_url; ?>/pndg-rpt-out.php" target="_blank">
...
<div class="col-sm-5">
  <input type="text" name="reservation" id="reservation" class="form-control" placeholder="Period Date" autocomplete="off" />
</div>
