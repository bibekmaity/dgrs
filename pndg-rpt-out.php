...
if($tk>0)
{
    ...
    { 
        ...
        <tr>
        <td colspan="12" align="center"  style=" border-top:none !important;border-bottom:none !important;"><B><?php echo "Pending Complaints <br />Period: $from_date1 - $to_date1";?></B></td>
        </tr>
        <tr>
        ...
        foreach ($row1 as $key => $value1) 
        {
            ...
            <td align="center"><?php echo "$ref_dt";?></td>
            </tr>
            <?php
        }
    	?>
